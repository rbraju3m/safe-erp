...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb breadcrumbbutton">
        ...
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.gallery.inactive')}} " class="btn btn-danger waves-effect pull-right">Inactive Gallery</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.gallery.index')
          <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.gallery.index')}} " class="btn btn-success waves-effect pull-right">Active Gallery</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.gallery.create')
        @if(Auth::user()->type == 'Admin')
        
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.gallery.create')}} " class="btn btn-primary waves-effect pull-right">Add Gallery</a>
        @endif
        @endif
