...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb breadcrumbbutton">
        ...
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.deposite.inactive')}} " class="btn btn-danger waves-effect pull-right">Inactive deposite</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.deposite.index')
          <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.deposite.index')}} " class="btn btn-success waves-effect pull-right">Active deposite</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.deposite.create')
        @if(Auth::user()->type == 'Admin')
        
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.deposite.create')}} " class="btn btn-primary waves-effect pull-right">Add deposite</a>
        @endif
        @endif
