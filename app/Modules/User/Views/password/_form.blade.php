	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="form-group">
				...
				{!! Form::text('password',Input::old('password'),['id'=>'password','class' => 'form-control','Placeholder' => 'Enter New password']) !!}
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="form-group">
				...
				<span style="color: red">*</span> 
				{!! Form::text('confirm',Input::old('confirm'),['id'=>'confirm','class' => 'form-control','Placeholder' => 'Confirm Password']) !!}
