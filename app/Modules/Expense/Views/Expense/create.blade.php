...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb breadcrumbbutton">
        ...
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.expense.inactive')}} " class="btn btn-danger waves-effect pull-right">Inactive expense</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.expense.index')
          <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.expense.index')}} " class="btn btn-success waves-effect pull-right">Active expense</a>
        @endif
        
        @if (Route::currentRouteName() != 'admin.expense.create')
        @if(Auth::user()->type == 'Admin')
        
        <a style="margin-left: 2px;font-weight: bold;" href=" {{route('admin.expense.create')}} " class="btn btn-primary waves-effect pull-right">Add expense</a>
        @endif
        @endif
